...
const pcPortfolioIframe = document.querySelector(".portfolio .container .iframe");
...
contactSubmit.addEventListener("click", (e) => {
    ...
    if (!contactName.value || !contactEmail.value || !contactMessage.value ) {
        contactName.style.border = contactName.value ? "1px solid #102a42" : "1px solid tomato";
        contactEmail.style.border = contactEmail.value ? "1px solid #102a42" : "1px solid tomato";
        contactMessage.style.border = contactMessage.value ? "1px solid #102a42" : "1px solid tomato";
    }
    ...
    if (contactName.value && emailIsValid(contactEmail.value) && contactMessage.value) {
        const thankContact = document.querySelector(".thank-contact");
        thankContact.innerText = "Thank you for your message, I will get back to you shortly!";
